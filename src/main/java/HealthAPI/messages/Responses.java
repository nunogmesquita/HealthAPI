...
public class Responses {
    ...
    public static final String DELETED_TIMESLOT = "Timeslot %s have been successfully deleted.";
    ...
    public static final String AGE = "You must have at least 18 years old.";
    ...
    public static final String CLIENT_NOT_FOUND = "Client %s not found.";
